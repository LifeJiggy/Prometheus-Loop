...
declare -A HARNESS_CONFIG=(
    ...
    ["claude"]="~/.claude/skills|~/.claude|claude|--version|~/.claude"
    ["codex"]="~/.agents/skills|~/.codex|codex|--version|~/.codex"
    ["opencode"]="~/.claude/skills|~/.config/opencode|opencode|--version|~/.config/opencode"
    ["hermes"]="~/.hermes/skills|~/.hermes|hermes|--version|~/.hermes"
    ...
    ["roo"]="~/.roo/skills|~/.roo|roo|--version|~/.roo"
    ["amea"]="~/.amea/skills|~/.amea|amea|--version|~/.amea"
    ["void"]="~/.void/skills|~/.void|void|--version|~/.void"
    ["junie"]="~/.junie/skills|~/.junie|junie|--version|~/.junie"
    ["pearai"]="~/.pearai/skills|~/.pearai|pearai|--version|~/.pearai"
    ["sweep"]="~/.sweep/skills|~/.sweep|sweep|--version|~/.sweep"
    ["ai-toolkit"]="~/.ai-toolkit/skills|~/.ai-toolkit|ai-toolkit|--version|~/.ai-toolkit"
    ["supermaven"]="~/.supermaven/skills|~/.supermaven|supermaven|--version|~/.supermaven"
)
